...
# assets/Crafted Logo.svg: the .st* <style> classes are flattened to
# presentation attributes (so they can't collide with page CSS) and the
# viewBox is tightened from the raw 2000x1000 artboard to the artwork's true
# bounds (measured 161.41,298.85 -> 1845.81,714.86, 6px padding) so we don't
# ship the empty margin. Update this by re-exporting the asset and re-running
# the same flatten/tighten. Sized via the .brand-logo CSS rule.
LOGO_SVG = (
    '<svg class="brand-logo" xmlns="http://www.w3.org/2000/svg" '
    'viewBox="155.41 292.85 1696.4 428.01" role="img" aria-label="CraftED">'
    '<rect fill="#e2b64e" x="161.41" y="298.85" width="449.32" height="416.01" rx="74.26" ry="74.26"/>'
    '<circle fill="none" stroke="#103c40" stroke-dasharray="43.98 39.58" stroke-miterlimit="10" stroke-width="3.61" cx="386.57" cy="511.34" r="132.99" transform="translate(-248.35 423.11) rotate(-45)"/>'
    '<circle fill="none" stroke="#103c40" stroke-dasharray="0 83.56" stroke-linecap="round" stroke-linejoin="round" stroke-width="30.09" cx="386.57" cy="511.34" r="132.99"/>'
    '<g>'
    '<path fill="#fff" d="M853.73,639.22c-31.47,0-55.99-10.61-73.55-31.84-17.57-21.22-26.35-53.91-26.35-98.07s8.78-77.15,26.35-98.26c17.57-21.1,42.08-31.65,73.55-31.65,17.57,0,33.3,3.42,47.21,10.25,13.91,6.83,24.88,17.45,32.94,31.84,8.05,14.4,12.08,32.93,12.08,55.62h-47.94c0-19.52-4.09-33.97-12.26-43.36-8.18-9.39-18.85-14.09-32.02-14.09-17.33,0-30.25,7.14-38.79,21.41-8.54,14.27-12.81,33.98-12.81,59.1v18.3c0,25.13,4.39,44.83,13.17,59.1,8.78,14.27,22.08,21.41,39.89,21.41,13.66,0,24.58-4.69,32.75-14.09,8.17-9.39,12.26-23.72,12.26-43h45.74c0,21.96-4.03,40.13-12.08,54.53-8.05,14.4-18.97,25.13-32.75,32.2-13.79,7.07-29.58,10.61-47.39,10.61Z"/>'
    '<path fill="#fff" d="M978.15,634.83v-192.49h36.59l5.12,28.18h2.2c2.68-8.05,6.46-15.49,11.34-22.32,4.88-6.83,12.2-10.25,21.96-10.25,5.61,0,11.71.98,18.3,2.93v42.45h-15.74c-6.35,0-12.26,1.34-17.75,4.03-5.49,2.69-9.88,7.2-13.17,13.54-3.29,6.35-4.94,15.25-4.94,26.71v107.22h-43.91Z"/>'
    '<path fill="#fff" d="M1128.19,639.22c-4.39,0-9.39-.73-15-2.2-5.61-1.46-10.92-4.15-15.92-8.05-5-3.9-9.15-9.39-12.44-16.47-3.29-7.07-4.94-16.22-4.94-27.45,0-17.32,4.08-30.86,12.26-40.62,8.17-9.75,19.45-16.65,33.85-20.68,14.39-4.03,30.86-6.04,49.4-6.04v-20.13c0-6.59-1.22-12.2-3.66-16.83-2.44-4.63-7.93-6.95-16.47-6.95-9.03,0-15.13,2.2-18.3,6.59-3.17,4.39-4.76,8.91-4.76,13.54v5.49h-42.82c-.25-1.22-.37-2.44-.37-3.66v-4.39c0-16.1,5.91-29.03,17.75-38.79,11.83-9.75,27.63-14.64,47.39-14.64,22.44,0,38.97,4.94,49.58,14.82s15.92,23.85,15.92,41.9v94.78c0,4.64,1.1,7.93,3.29,9.88,2.2,1.96,4.51,2.93,6.95,2.93h8.78v31.11c-2.44,1.22-5.74,2.5-9.88,3.84-4.15,1.34-9.51,2.01-16.1,2.01-8.78,0-16.1-2.32-21.96-6.95-5.85-4.63-9.88-10.73-12.08-18.3h-1.83c-5.37,7.56-11.59,13.67-18.66,18.3-7.08,4.63-17.08,6.95-30.01,6.95ZM1146.48,602.63c7.07,0,12.68-1.95,16.83-5.86,4.15-3.9,7.19-9.02,9.15-15.37,1.95-6.34,2.93-13.29,2.93-20.86v-10.98c-8.54,0-16.65.91-24.33,2.74-7.69,1.83-13.97,5-18.85,9.51-4.88,4.52-7.32,10.92-7.32,19.21,0,6.59,1.7,11.84,5.12,15.74,3.41,3.91,8.9,5.86,16.47,5.86Z"/>'
    '<path fill="#fff" d="M1264.32,634.83v-155.53h-19.39v-36.96h19.39v-23.42c0-8.54,1.34-16.77,4.03-24.7,2.68-7.92,7.32-14.39,13.91-19.4,6.59-5,15.74-7.5,27.45-7.5,5.12,0,10.8.43,17.02,1.28,6.22.86,11.16,1.89,14.82,3.11v32.57h-17.93c-10.25,0-15.37,5.25-15.37,15.74v22.32h33.3v36.96h-33.3v155.53h-43.91Z"/>'
    '<path fill="#fff" d="M1409.6,639.22c-11.71,0-20.86-2.5-27.45-7.5-6.59-5-11.22-11.46-13.91-19.4-2.69-7.92-4.03-16.16-4.03-24.7v-108.32h-19.39v-36.96h19.39l6.59-54.16h37.33v54.16h27.81v36.96h-27.81v107.22c0,10.49,5.12,15.74,15.37,15.74h12.44v32.57c-3.17.97-7.32,1.95-12.44,2.93-5.12.97-9.76,1.46-13.91,1.46Z"/>'
    '<path fill="#e2b64e" d="M1463.39,634.83v-251.04h159.92v41.72h-113.08v60.01h96.97v41.72h-96.97v65.87h115.27v41.72h-162.11Z"/>'
    '<path fill="#e2b64e" d="M1663.56,634.83v-251.04h81.61c31.22,0,55.81,10.19,73.74,30.56,17.93,20.37,26.9,50.81,26.9,91.3,0,42.94-8.97,75.2-26.9,96.79-17.93,21.59-42.51,32.39-73.74,32.39h-81.61ZM1710.4,593.12h30.37c17.32,0,31.11-6.52,41.35-19.58,10.25-13.05,15.37-32.63,15.37-58.73v-18.3c0-23.66-5.12-41.41-15.37-53.25-10.25-11.83-24.03-17.75-41.35-17.75h-30.37v167.6Z"/>'
    '</g>'
    '<path fill="#103c40" d="M358.89,572.85c-.79.08-2.35.09-3.13,0-7.62-.9-10.5-8.52-10.69-15.26.18-35.37-.39-70.78.29-106.12,2.48-13.82,11.98-14.34,22.83-8.55,29.97,15.97,58.61,34.63,88.48,50.8,10.35,5.95,12.16,16.16,1.93,23.54-30.46,16.65-59.79,35.68-90.42,52-2.75,1.47-6.17,3.27-9.3,3.61Z"/>'
    '</svg>'
)
